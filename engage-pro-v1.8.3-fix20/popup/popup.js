(function() {
  ...
  const els = {
    ...
    telegramControls: document.getElementById('telegramControls'),
  ...
  function updateUI() {
    ...
    if (state.operationMode === 'followers') {
      ...
      els.telegramControls.classList.add('hidden');
      els.engagementToggles.classList.add('hidden');
    } else if (state.operationMode === 'telegram') {
      els.followerControls.classList.add('hidden');
      els.telegramControls.classList.remove('hidden');
      els.engagementToggles.classList.add('hidden');
    } else {
      els.followerControls.classList.add('hidden');
      els.telegramControls.classList.add('hidden');
  ...
  els.startBtn.addEventListener('click', async () => {
    ...
    if (state.operationMode === 'followers') {
      ...
      // For Telegram mode, open sidepanel to guide user
      chrome.sidePanel.open({ windowId: chrome.windows.WINDOW_ID_CURRENT });
      // Don't set isRunning - Telegram queue is managed separately
